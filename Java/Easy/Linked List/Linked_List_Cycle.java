...
public class Solution {
    public boolean hasCycle(ListNode head) {
        ...
        // If no cycle, fast will equal null before slow, loop will break
        // If cycle, fast will never = null and will loop back around
        // Once fast = slow (it will eventually catch up), we can say there is a cycle
        // Time Complexity: O(n)
