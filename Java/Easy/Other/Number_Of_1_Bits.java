...
/*
	...
	integers using 2's complement notation. Therefore, in Example 3, 
...
public class Solution {
    ...
    public int hammingWeight(int n) {
        ...
        // Approach: Create a mask set to 1. & every bit with 1.
        // If the result is 1 then increment count. Shift the mask to the left
        // on every iteration of the loop (31 times).
        // Cheat: Can ultimately just return Integer.bitCount(n) which 
